...
/* -------- Fixed endianness detection (works on ESP32/Xtensa) -------- */
#ifndef PLATFORM_BYTE_ORDER
  /* Prefer compiler-provided byte-order macros */
  #if defined(__BYTE_ORDER__) && defined(__ORDER_LITTLE_ENDIAN__) && (__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__)
    #define PLATFORM_BYTE_ORDER IS_LITTLE_ENDIAN
  #elif defined(__BYTE_ORDER__) && defined(__ORDER_BIG_ENDIAN__) && (__BYTE_ORDER__ == __ORDER_BIG_ENDIAN__)
    #define PLATFORM_BYTE_ORDER IS_BIG_ENDIAN

  /* ESP32 / Xtensa targets are little-endian */
  #elif defined(__XTENSA__) || defined(__xtensa__) || defined(__ESP32__) || defined(ESP_PLATFORM)
    #define PLATFORM_BYTE_ORDER IS_LITTLE_ENDIAN
